...
```text
book/examples/ch01-rust-basics
book/examples/ch02-numeric-functions
...
```text
book/examples/ch01-rust-program-shape/src/bin/
```
...
- 为什么代码要分为 `book/examples` 和 `projects`？
...
```text
book/examples/ch01-rust-program-shape/src/bin/variables.rs
```
...
`book/examples` 是学习概念的地方，`projects` 是阶段成果。示例可以小而单一，项目要更像真实工程。
